...
public class AppRate implements android.content.DialogInterface.OnClickListener, OnCancelListener {
	...
	private void showDefaultDialog() {
		...
		new AlertDialog.Builder(hostActivity)
				.setTitle(String.format(hostActivity.getString(R.string.appRateTitle), hostActivity.getString(R.string.aadhk_app_name)))
				.setMessage(String.format(hostActivity.getString(R.string.appRateMessage), hostActivity.getString(R.string.aadhk_app_name)))
				.setPositiveButton(R.string.appRatePositive, this)
				.setNegativeButton(R.string.appRateNegative, this)
				.setNeutralButton(R.string.appRateNeutral, this)
